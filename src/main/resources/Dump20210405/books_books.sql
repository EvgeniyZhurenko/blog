...
CREATE TABLE `books` (
  ...
  `buyer_id` bigint(100) DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `buyerKey_idx` (`buyer_id`),
  CONSTRAINT `buyerKey` FOREIGN KEY (`buyer_id`) REFERENCES `buyers` (`buyer_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
